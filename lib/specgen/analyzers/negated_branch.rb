...
module SpecGen
  module Analyzers
    ...
    #
    # Уже при трёх значениях «не sbp» не называет ни одного из них, а IR
    # хранит равенство, а не отрицание: там #value пуст, и вызывающий
    # предупреждает. Отсутствие enum — тот же случай.
    class NegatedBranch
