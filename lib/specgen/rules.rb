...
require_relative 'rules/operation_tuning'
...
require_relative 'rules/requisite_map'
require_relative 'rules/failure_codes'
require_relative 'rules/platform_bindings'
require_relative 'rules/contract_book'
require_relative 'rules/errors_book'
require_relative 'rules/assumptions_book'
...
module SpecGen
  ...
  # высказанную прозой, сам контракт Provider::BaseService, политика
  # действий по ошибкам провайдера и допущения проекта, которые печатает
  # INTEGRATION.md.
  #
  ...
  module Rules
    ...
    # @return [Registry] все одиннадцать справочников, проверенные
