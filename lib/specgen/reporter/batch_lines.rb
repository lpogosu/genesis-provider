...
module SpecGen
  module Reporter
    ...
    class BatchLines
      ...
      # разброс первой колонки — от четверти до трёх четвертей — и делает из
      # него вывод об инструменте, хотя разброс описывает спецификации: чем
      # больше в файле посторонних ресурсов, тем ниже первая цифра.
