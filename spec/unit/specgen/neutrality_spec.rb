...
# записано в CLAUDE.md, но не проверялось ничем, и один комментарий его уже
...
RSpec.describe 'provider neutrality of the core' do
  ...
  # справочнике — ровно то, что CLAUDE.md запрещает.
  #
  # `bank_code` — исключение с оговоркой: CLAUDE.md запрещает это слово в
